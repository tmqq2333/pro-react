...
import { Button, Col, DatePicker, Drawer, Form, Input, message, Row, Select, Space, Tree } from 'antd';
      ...
      >
        ...
        >
          ...
          <Form.Item name="permissions" label="权限">
            <Tree checkable defaultExpandAll onCheck={onCheck} checkedKeys={checkedKeys} treeData={treeData} />
          </Form.Item>
        </Form>
      </Drawer>
    </>
